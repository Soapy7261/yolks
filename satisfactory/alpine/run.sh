...
if [[ "${SKIPUPDATE,,}" != "false" ]] && [ ! -f "/home/container/config/gamefiles/FactoryServer.sh" ]; then
...
if [[ "${SKIPUPDATE,,}" != "true" ]]; then
    ...
    steamcmd +force_install_dir /home/container/config/gamefiles +login anonymous +app_update "$STEAMAPPID" -beta "$STEAMBETAFLAG" validate +quit
    cp -r /home/container/.steam/steam/logs/* "/home/container/config/logs/steam" || printf "Failed to store Steam logs\\n"
else
